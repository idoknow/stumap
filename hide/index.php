...
.submit_btn:hover { 
	...
	<body>
		...
		<form id="input_form" action="hide.php" method="post">
			
						<h1>
				选择姓名以隐藏
			</h1>
			<h5>
			    注意：1.您的IP将会被记录并实时通过消息系统通知开发者<br/>
			    2.非国内IP的操作可能会被撤销,恶意编辑将会遭到IP封禁<br/>
			    3.此操作不可逆,请谨慎,误操作请联系qq1010553892
			</h5>
			...
			<input type="submit" class="submit_btn" onclick="onSubmit()">
